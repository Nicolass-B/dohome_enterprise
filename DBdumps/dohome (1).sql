...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 20 mai 2017 à 17:04
...
INSERT INTO `capteurs` (`ID_Capteurs`, `Type`, `Valeur`, `Date_Installation`, `Etat_Batterie`, `ID_piece`) VALUES
(1, 'temp', 20, '2017-05-19', 100, 1);
...
INSERT INTO `maison` (`Id`, `nbpieces`, `ID_user`) VALUES
(1, 1, 1);
...
(1, 'mabite@gmail.xxx', 'Nicolas', 'Kiris', '064206969', 'azerty', 'no', 0, '0000-00-00 00:00:00', '0000-00-00', NULL),
(2, 'test@test.Com', 'Nicolas', 'lelelelel', '064206969', 'azerty', 'no', 0, '0000-00-00 00:00:00', '0000-00-00', NULL);
...
--
ALTER TABLE `capteurs`
  MODIFY `ID_Capteurs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
