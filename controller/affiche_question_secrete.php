...
if($affiche['nb_ocu']==1 || isset($msg)){
    ...
    <br><br>
        ...
        <br>
    <input type="password" name="newpass" id="newpass" placeholder="entrez votre nouveau mot de passe" value="" required/>
    <br>
        <label for="newpassconfirm">Confirmation de mot de passe</label>
        <br>
    <input type="password" name="newpassconfirm" id="newpassconfirm" placeholder="confirmez votre nouveau mot de passe" value="" required/>
        <br><br>
        <input type="hidden" name="mail" value="<?php echo $mailEnter?>">

        <input type="submit" name="envoi"  value="Changer votre mot de passe" required/>
