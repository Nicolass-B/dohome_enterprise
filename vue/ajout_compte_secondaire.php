                ...
                <div class="test">
                    <div class="test1">
                        <p>
                            ...
                            <input type="text" name="nomUserSec" id="nomUserSec" placeholder="Entrez votre nom"
                                   required/>
                        </p>
                        <label for="prenomUserSec">Prénom </br></label>
                        <input type="text" name="prenomUserSec" id="prenomUserSec" placeholder="Entrez votre prénom"
                               required/>
                        <br><br>
                        <label for="E-mailUserSec">E-mail </br></label>
                        <input type="email" name="E-mailUserSec" id="E-mailUserSec"
                               placeholder="Entrez votre adresse mail" required/>
                        <br><br>
                        <label for="passUserSec">Mot de passe </br></label>
                        <input type="password" name="passUserSec" id="passUserSec"
                               placeholder="Entrez votre mot de passe" required/>
                        <br><br>
                        <label for="confirmePasseUserSec">Confirmation du mot de passe </br></label>
                        <input type="password" name="confirmePasseUserSec" id="confirmePasseUserSec"
                        ...
                        <br><br>
                        <input class="bouton1" type="submit" name="formulaireAjoutSec"
                               value="ajouter mon compte secondaire"/>
                        <p>
