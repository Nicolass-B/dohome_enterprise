            ...
            <fieldset>
                ...
                <div class="test">
                    <div class="test1">
                        ...
                        <input type="text" name="nom" id="nom" placeholder="Entrez votre nom" value="<?php if(isset($_SESSION['nom'])&& !empty($_SESSION['nom'])){echo $_SESSION['nom'];} ?>" required/>
                        </p>

                        <label for="prenom">Prénom </br></label>
                        <input type="text" name="prenom" id="prenom" placeholder="Entrez votre prénom" value="<?php if(isset($_SESSION['prenom'])&& !empty($_SESSION['prenom'])){echo $_SESSION['prenom'];} ?>" required/>
                        </br></br>
                        <label for="E-mail">E-mail </br></label>
                        <input type="email" name="E-mail" id="E-mail" placeholder="Entrez votre adresse mail" value="<?php if(isset($_SESSION['E-mail'])&& !empty($_SESSION['E-mail'])){echo $_SESSION['E-mail'];} ?>" required/>
                        </br></br>
                        ...
                        <input type="text" name="adresse" id="adresse" placeholder="Adresse/Code postal/Ville" value="<?php if(isset($_SESSION['adresse'])&& !empty($_SESSION['adresse'])){echo $_SESSION['adresse'];} ?>" required/>
                        </br></br>
                    ...
                    <div class="test2">
                        <p>
                            ...
                            <select name="sexe" id="sexe"  >
                                <option value="homme" <?php if(isset($_SESSION['sexe'])&& !empty($_SESSION['sexe']) &&$_SESSION['sexe']=='homme'){echo'selected';} ?> >Homme</option>
                                <option value="femme" <?php if(isset($_SESSION['sexe'])&& !empty($_SESSION['sexe']) &&$_SESSION['sexe']=='femme'){echo'selected';} ?> >Femme</option>
                            </select>
                        </p>
                        ...
                        <p>
                            ...
                            <input type="tel" name="tel" id="tel" placeholder="Entrez votre numéro de téléphone" maxlength="10" pattern="^[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]$" value="<?php if(isset($_SESSION['tel'])&& !empty($_SESSION['tel'])){echo $_SESSION['tel'];} ?>" required/>
                        </p>
